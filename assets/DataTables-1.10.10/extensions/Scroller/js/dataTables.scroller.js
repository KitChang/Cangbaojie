...
$.extend( Scroller.prototype, {
	 ...
	 * all of the records into a finite street, but this function returns a linear
...
Scroller.defaults = /** @lends Scroller.defaults */{
	 ...
	 * rows that will be shown in "near scrolling" (i.e. just beyond the current display street).
